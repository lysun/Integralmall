...
<jsp:attribute name="nav">
	...
	<script id="template" type="text/html">
		...
		<script>
			$(function(){
				ajax('<c:url value="/admin/perm/getlist"/>',null,"get",showList);
			});
			...
			function showList(data){
				...
				$("tbody").append(html);
				//初始化分页
				pagination(data.data.totalPages,data.data.size,'<c:url value="/admin/perm/getlist"/>',
						null,showList);
			}
		</script>
	</jsp:attribute>
	<jsp:body>
	<button class="btn btn-default" onclick="window.location.href='<c:url value="/admin/perm/add"/>'">添加</button>
