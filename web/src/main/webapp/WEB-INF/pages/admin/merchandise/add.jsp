	...
	<jsp:body>
		<form action="./" role="form" class="form-horizontal" method="post" enctype="multipart/form-data" onsubmit="return validate()">
          ...
          <div class="form-group">
               ...
               <div class="col-sm-10">
                   <input id="actual" name="isActual" type="checkbox" value="1"/>
               </div>
           </div>
           <div class="form-group">
           ...
           <div class="form-group">
               ...
               <div class="col-sm-10">
                   <input id="expiryTime" class="form-control" name="expiryTime" placeholder="例如:格式为2001-01-01">
               </div>
           </div>
           <div class="form-group">
